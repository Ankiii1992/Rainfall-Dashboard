...
<style>
    ...
    .title-text { font-size: 2.8rem; font-weight: 800; color: #1a237e; padding: 1rem 0; }
    .metric-tile {
...
def load_all_sheet_tabs():
    ...
    data_by_date = {}
    for tab in spreadsheet.worksheets():
        data = tab.get_all_values()
        if not data or len(data) < 2:
            continue
        df = pd.DataFrame(data[1:], columns=data[0]).replace("", pd.NA).dropna(how="all")
...
category_colors = {
    "Very Light": "#c8e6c9", "Light": "#00ff01", "Moderate": "#ffff00",
    "Rather Heavy": "#ffa500", "Heavy": "#d61a1c", "Very Heavy": "#3b0030",
    "Extremely Heavy": "#4c0073", "Exceptional": "#ffdbff"
}

category_ranges = {
    "Very Light": "0.1 – 2.4 mm", "Light": "2.5 – 7.5 mm", "Moderate": "7.6 – 35.5 mm",
    "Rather Heavy": "35.6 – 64.4 mm", "Heavy": "64.5 – 124.4 mm", "Very Heavy": "124.5 – 244.4 mm",
...
slot_labels = {
    "06TO08": "6–8 AM", "08TO10": "8–10 AM", "10TO12": "10–12 AM", "12TO14": "12–2 PM",
    "14TO16": "2–4 PM", "16TO18": "4–6 PM", "18TO20": "6–8 PM", "20TO22": "8–10 PM",
    "22TO24": "10–12 PM", "24TO02": "12–2 AM", "02TO04": "2–4 AM", "04TO06": "4–6 AM"
}
